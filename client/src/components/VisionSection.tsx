...
export default function VisionSection() {
  ...
  return (
    <section id="vision" className="min-h-screen bg-corporate-gradient flex items-center justify-center px-6 py-32 relative overflow-hidden">
      ...
      <div className="absolute top-20 -left-32 w-[700px] h-[700px] bg-gradient-radial from-purple-400/35 via-pink-400/20 to-transparent rounded-full blur-3xl" />
      <div className="absolute bottom-20 left-0 w-[800px] h-[800px] bg-gradient-radial from-indigo-400/30 via-purple-400/15 to-transparent rounded-full blur-3xl" />
      <div className="absolute top-1/2 left-20 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-radial from-pink-400/25 via-transparent to-transparent rounded-full blur-3xl" />
      ...
      <div className="max-w-7xl mx-auto text-center space-y-20 relative z-10">
        ...
        <div ref={headlineParallax.ref} style={headlineParallax.style} className="space-y-8 animate-fade-in-up">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-foreground leading-[1.1]" style={{ letterSpacing: '-0.01em' }}>
            AI That Transforms Psychosocial Compliance into Culture
          </h1>
