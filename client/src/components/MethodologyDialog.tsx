      ...
      <DialogContent className="max-w-5xl h-[90vh] p-0">
        <DialogHeader className="px-6 pt-6 pb-4 border-b bg-card">
          <div className="flex items-center justify-between">
            ...
            <DialogDescription className="sr-only">
              Comprehensive research documentation and calculation methodology for the CultureCrunch ROI Calculator
            </DialogDescription>
            <Button
              variant="ghost"
              size="icon"
        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 pointer-events-none z-10 flex items-center justify-center opacity-5">
            <div className="transform -rotate-45 text-6xl font-bold text-foreground whitespace-nowrap">
          ...
          <ScrollArea className="h-[calc(90vh-120px)] px-6 py-4">
            ...
            <div className="select-none" onContextMenu={(e) => e.preventDefault()}>
              ...
              <section className="mb-8">
                ...
                <h3 className="text-lg font-bold text-foreground mb-2">Primary Source:</h3>
                <p className="text-muted-foreground mb-3">
                ...
                <h3 className="text-lg font-bold text-foreground mb-2">Aged Care Context:</h3>
                <p className="text-muted-foreground mb-2"><strong>Key Psychosocial Hazards in Aged Care:</strong></p>
              ...
              {/* 2. Turnover Cost */}
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-foreground mb-4">2. Turnover Cost Multiplier (Aged Care Sector)</h2>
                <div className="bg-purple-50 p-4 rounded-lg mb-4">
                ...
                <h3 className="text-lg font-bold text-foreground mb-2">Aged Care Calculator Methodology:</h3>
                <p className="text-muted-foreground mb-2">Uses 70% (0.7×) as <strong>sector-appropriate</strong> estimate:</p>
                <ul className="list-disc list-inside text-muted-foreground space-y-1">
              ...
              {/* 3. Productivity Loss */}
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-foreground mb-4">3. Productivity Loss from Disengagement (Aged Care Context)</h2>
                <div className="bg-purple-50 p-4 rounded-lg mb-4">
                ...
                <p className="text-muted-foreground text-sm mb-2">Example: 65 aged care staff × (1 - 0.45) = 36 disengaged workers</p>
                <p className="text-muted-foreground mb-2">
                  <strong>Annual productivity loss</strong> = Disengaged employees × Average salary × 18%
                </p>
                <p className="text-muted-foreground text-sm">Conservative 18% applied despite higher aged care workforce stress levels</p>
              </section>

              {/* 4. Absenteeism */}
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-foreground mb-4">4. Absenteeism Cost (Aged Care Sector)</h2>
                <div className="bg-purple-50 p-4 rounded-lg mb-4">
                ...
                <h3 className="text-lg font-bold text-foreground mb-2">Aged Care Calculator Methodology:</h3>
                <p className="text-muted-foreground mb-2">$3,500 per employee represents:</p>
                <ul className="list-disc list-inside text-muted-foreground space-y-1">
                ...
                <p className="text-muted-foreground text-sm mt-2">Conservative given sector-specific stress factors and coverage challenges</p>
              </section>
              ...
              {/* 6. Key Metrics Table */}
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-foreground mb-4">6. Key Metrics - Aged Care Sector Sources</h2>
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse border border-border">
                    <thead className="bg-purple-100">
                      <tr>
                        <th className="border border-border p-3 text-left font-bold text-foreground">Metric</th>
                        <th className="border border-border p-3 text-left font-bold text-foreground">Value</th>
                        <th className="border border-border p-3 text-left font-bold text-foreground">Aged Care Sector Source</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr className="bg-white">
                        <td className="border border-border p-3 text-muted-foreground">Mental Health Claim Cost</td>
                        <td className="border border-border p-3 text-muted-foreground">$58.6K</td>
                        <td className="border border-border p-3 text-muted-foreground">Safe Work Australia 2020-21 (Aged Care)</td>
                      </tr>
                      <tr className="bg-gray-50">
                        <td className="border border-border p-3 text-muted-foreground">Claim Time Off</td>
                        <td className="border border-border p-3 text-muted-foreground">34 weeks</td>
                        <td className="border border-border p-3 text-muted-foreground">Safe Work Australia (4× other injuries)</td>
                      </tr>
                      <tr className="bg-white">
                        <td className="border border-border p-3 text-muted-foreground">Turnover Cost Multiplier</td>
                        <td className="border border-border p-3 text-muted-foreground">70%</td>
                        <td className="border border-border p-3 text-muted-foreground">Aged Care Workforce Survey 2023</td>
                      </tr>
                      <tr className="bg-gray-50">
                        <td className="border border-border p-3 text-muted-foreground">Workforce Turnover Rate</td>
                        <td className="border border-border p-3 text-muted-foreground">27%</td>
                        <td className="border border-border p-3 text-muted-foreground">84,900 staff exits (Workforce Survey)</td>
                      </tr>
                      <tr className="bg-white">
                        <td className="border border-border p-3 text-muted-foreground">Productivity Gap</td>
                        <td className="border border-border p-3 text-muted-foreground">18%</td>
                        <td className="border border-border p-3 text-muted-foreground">Gallup (49% manageable workload context)</td>
                      </tr>
                      <tr className="bg-gray-50">
                        <td className="border border-border p-3 text-muted-foreground">Absenteeism Cost</td>
                        <td className="border border-border p-3 text-muted-foreground">$3,500/employee</td>
                        <td className="border border-border p-3 text-muted-foreground">Safe Work Australia (Aged Care Hazards)</td>
                      </tr>
                      <tr className="bg-white">
                        <td className="border border-border p-3 text-muted-foreground">Claims Reduction</td>
                        <td className="border border-border p-3 text-muted-foreground">40%</td>
                        <td className="border border-border p-3 text-muted-foreground">Compliance enforcement context</td>
                      </tr>
                      <tr className="bg-gray-50">
                        <td className="border border-border p-3 text-muted-foreground">Turnover Reduction</td>
                        <td className="border border-border p-3 text-muted-foreground">25%</td>
                        <td className="border border-border p-3 text-muted-foreground">Leadership support (43K vacancies context)</td>
                      </tr>
                      <tr className="bg-white">
                        <td className="border border-border p-3 text-muted-foreground">Productivity Improvement</td>
                        <td className="border border-border p-3 text-muted-foreground">30%</td>
                        <td className="border border-border p-3 text-muted-foreground">Engagement interventions (sector hazards)</td>
                      </tr>
                      <tr className="bg-gray-50">
                        <td className="border border-border p-3 text-muted-foreground">Absenteeism Reduction</td>
                        <td className="border border-border p-3 text-muted-foreground">20%</td>
                        <td className="border border-border p-3 text-muted-foreground">Preventive support (NSW inspector increase)</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              {/* 7. Credibility */}
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-foreground mb-4">7. Why This Aged Care ROI Model is Defensible</h2>
                <div className="space-y-3">
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <h3 className="font-bold text-blue-900 mb-1">Aged Care Sector-Specific Data</h3>
                    <p className="text-sm text-muted-foreground">Safe Work Australia aged care data (2020-21), Aged Care Quality & Safety Commission 
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">All improvement rates conservative given compliance enforcement reality: 82% residential 
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">Aged Care Quality & Safety Commission (federal regulator), Safe Work Australia (national 
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">ROI model addresses documented aged care hazards: resident aggression, dementia behaviors, 
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">Victoria psychological health regulations (Dec 2025), escalating enforcement, and 1-in-5 
              ...
              {/* Footer Notice */}
              <div className="bg-gray-100 border-t-2 border-border rounded-lg p-6 mt-8">
